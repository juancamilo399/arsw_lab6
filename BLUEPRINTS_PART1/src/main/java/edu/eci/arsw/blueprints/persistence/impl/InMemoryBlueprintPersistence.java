...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence{
    ...
    public InMemoryBlueprintPersistence() {
        ...
        Point[] ptsJp=new Point[]{new Point(250, 100),new Point(250, 200),new Point(350,200),new Point(350,100),new Point(250,100),new Point(300,50),new Point(350,100)};
        Blueprint bpJp=new Blueprint("JhonConnor", "house",ptsJp);
        blueprints.put(new Tuple<>(bpJp.getAuthor(),bpJp.getName()), bpJp);
        
        Point[] ptsSt=new Point[]{new Point(0, 0),new Point(100, 100)};
        Blueprint bpSt=new Blueprint("JhonConnor", "bike",ptsSt);
        blueprints.put(new Tuple<>(bpSt.getAuthor(),bpSt.getName()), bpSt);
        
        Point[] ptsSt2=new Point[]{new Point(50, 1),new Point(1, 05)};
        Blueprint bpSt2=new Blueprint("LexLuthor", "kryptonite",ptsSt2);
